...
[ScalarKernels]
  ...
  [I3] #First Wall
    ...
    postprocessors = 'P_FW_leak_fraction burn_pulse HX_FW_leak_fraction residence5 residence3 tdecay epsilon3'
  []
  ...
  [I7] #Vacuum Pump
    ...
    variable = 'T_07_vacuum'
    postprocessors = 'burn_pulse TBE P_FW_leak_fraction P_DIV_leak_fraction residence7 tdecay epsilon7'
  []
  [I8] #Fuel clean-up
    type = ParsedODEKernel
  ...
  [I10] #Storage and Management (STO)
    ...
    postprocessors = 'ISS_DS_leak_fraction DIR_fraction burn_pulse residence9 residence7 residence11 tdecay'
  []
...
[]
[Outputs]
  hide = "AF HX_BZ_leak_fraction HX_FW_leak_fraction HX_DS_leak_fraction ISS_DS_leak_fraction P_DIV_leak_fraction P_FW_leak_fraction TES_efficiency TBR DIR_fraction T_BZ T_DS T_DIV T_TSM T_FCU T_FW T_HX T_ISS T_STO T_TES T_VAC epsilon1 epsilon11 epsilon2 epsilon3 epsilon4 epsilon5 epsilon6 epsilon7 epsilon8 epsilon9 residence1 residence11 residence2 residence3 residence4 residence5 residence6 residence7 residence8 residence9 tdecay TBE tritium_burn_rate"
  file_base = 'fuel_cycle_update_test_out'
  csv = true
  console = false
[]
